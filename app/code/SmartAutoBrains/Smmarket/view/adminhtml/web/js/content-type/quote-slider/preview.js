...
define([
    ...
    Preview.prototype.retrieveOptions = function retrieveOptions() {
        ...
        options.add = new Option({
            ...
            title: Translate("Add"),
            action: this.addQuoteSliderItem,
            classes: ["add-child"],
            sort: 10
        });
    ...
    Preview.prototype.addQuoteSliderItem = function  addQuoteSliderItem() {
        var self = this;

        ContentTypeFactory(Config.getContentTypeConfig("quote_slider_item"), self.contentType, self.contentType.stageId)
            .then(function (sliderItem) {
                self.contentType.addChild(sliderItem, self.contentType.children().length);
            });
    };
