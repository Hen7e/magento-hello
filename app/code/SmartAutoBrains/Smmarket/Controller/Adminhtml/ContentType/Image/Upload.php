...
namespace Astound\ContentTypes\Controller\Adminhtml\ContentType\Image;
...
class Upload extends \Magento\Backend\App\Action implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            if (!$fileUploader->checkMimeType(['image/png', 'image/jpeg', 'image/gif', 'image/svg', 'text/plain'])) {
